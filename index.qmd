...
Data <-
  ...
  as.data.frame() |>
  # Remove columns.
  select(-c("Used","Duplicate","Not_Digitized","Age.2","Age.PD")) # 2448 occurrences with species names.
```
...
# Campanian
set.seed(1)
boot_campanian <- boot_age(x = campanian_split,n_boot = 999,n_strata = 8,n_per_stratum = 10)
# Maastrichtian.
set.seed(2)
boot_maastrichtian <- boot_age(x = maastrichtian_split,n_boot = 999,n_strata = 8,n_per_stratum = 10)
# Danian-Selandian.
set.seed(3)
boot_danian <- boot_age(x = danian_split,n_boot = 999,n_strata = 8,n_per_stratum = 10)
# Thanetian.
set.seed(4)
boot_thanetian <- boot_age(x = thanetian_split,n_boot = 999,n_strata = 8,n_per_stratum = 10)
